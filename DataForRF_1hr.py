...
for dirname in os.listdir('C:/Users/SyuShengWei/Desktop/project/RegularSplitByStation'):
	...
	for filename in os.listdir('C:/Users/SyuShengWei/Desktop/project/RegularSplitByStation/'+dirname):
		...
		while True :
			...
			if theLine == '' : break 
				...
				rentDate = lineInfo[0]
				peroid = math.floor(int(lineInfo[1]) / 3600)
	...
	if not os.path.exists('DataForRF_1HR'):
		os.makedirs('DataForRF_1HR')
	os.chdir('C:/Users/SyuShengWei/Desktop/project/DataForRF_1HR')
