...
for filename in os.listdir('C:/Users/SyuShengWei/Desktop/project/RegularSplitByStation/000-捷運台北101(世貿站)'):
	totalOD = 0
	os.chdir('C:/Users/SyuShengWei/Desktop/project/RegularSplitByStation/000-捷運台北101(世貿站)')
...
os.chdir('C:/Users/SyuShengWei/Desktop/project/Analysis/000-捷運台北101(世貿站)')
...
for peroid in range(0,96):
	if Top10_Day_Staton[peroid][0] != 1 : continue
	else :
